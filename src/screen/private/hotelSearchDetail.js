    ...
    <SafeAreaView>
      <ScrollView contentContainerStyle={{backgroundColor: '#FFFFFF'}}>
        ...
        <View style={{alignSelf: 'center', width: wp('96%'),borderRadius:10}}>
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-between',marginTop:'5%'}}>
            <View>
              ...
              <Text style={{fontSize: 10, color: '#707070', fontWeight: '400'}}>
                7.5kms from airport
              </Text>
            </View>
            <Image
              source={require('../../assets/images/star.png')}
              style={{marginTop: hp('1%'), marginRight: wp('3%')}}
            />
          </View>
          <View
            style={{
            ...
            <Text style={{color: '#0F63F4', fontSize: 17, fontWeight: '600'}}>
              $50.00
            </Text>
            <TouchableOpacity
              style={{
        ...
        <FlatList
          ...
          <Image source={require('../../assets/images/water.png')} style={{width:wp('43%'),height:hp('25%'),borderRadius:5}} />
          <View style={{flexDirection: 'row', justifyContent: 'space-between',alignItems:'center',marginTop:hp('1.5%')}}>
            ...
            <Image
              source={require('../../assets/images/star.png')}
              style={{width:45,height:7,marginRight:wp('4%'),justifyContent:'center'}}
            />
          </View>
          <View
            style={{
